...
const Intermediate= () => {
  ...
  const fetchAnswer = async (question) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/answer/intermediate`, { text: question });
          ...
          <VantaBackgroundWrapper>
            <div className="card shadow-lg rounded-3 " style={{ marginTop: "50px", marginBottom: "20px" }}>
              <div className="card-body">
                <h2 className="text-center mb-4">Intermediate Level English Speaking Test</h2>
                {!aiQuestion && (
                  <div className="text-center">
                    <button className="btn btn-primary" onClick={handleSubmit}>Click Here!!</button>
                  </div>
                )}
                {loading && (
                  ...
                  <div className="mt-5 p-3 bg-light rounded border">
                    ...
                    <div className="mt-3">
                      ...
                      <div className="d-flex gap-3 mb-3">
                        ...
                        <button onClick={analyzeTranscript} className="btn btn-primary">{!load?"Check Analyasis":(<img src={circle} alt="Loading" style={{ width: "20px", height: "20px" }} />)}</button>
                      </div>
                    </div>
                    <div className="mt-4">
