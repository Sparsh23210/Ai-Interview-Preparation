          ...
          <VantaBackgroundWrapper>
            <div className="card shadow-lg rounded-3 " style={{ marginTop: "50px", marginBottom: "20px" }}>
              <div className="card-body">
                <h2 className="text-center mb-4">Expert Level English Speaking Test</h2>
                {!aiQuestion && (
                  ...
                  <div className="mt-5 p-3 bg-light rounded border">
                    ...
                    <div className="mt-3">
                      ...
                      <div className="d-flex gap-3 mb-3">
                        ...
                        <button onClick={analyzeTranscript} className="btn btn-primary"style={{borderRadius:"20px"}}>{!load?"Check Analysis":(<img src={circle} alt="Loading" style={{ width: "20px", height: "20px" }} />)}</button>
                      </div>
                    </div>
                    <div className="mt-4">
